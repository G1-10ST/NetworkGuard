...
#    Nov 18, 2019 10:16:37 AM IST  platform: Linux
...
class Toplevel1:
    ...
    def task2(self):
        ...
        p2 = subprocess.Popen(["tcpdump","-nn","-r","server2.pcap"], stdout=subprocess.PIPE, stderr=subprocess.PIPE)
        ...
        while True:
            ...
            if not txt2:
                break
            txt2.rstrip()
            self.Scrolledlistbox1_2.insert(1,txt2)
    ...
    def __init__(self, top=None):
        ...
        self.Scrolledlistbox1.place(relx=0.036, rely=0.243, relheight=0.556
                , relwidth=0.407)
        ...
        self.Scrolledlistbox1_2.place(relx=0.473, rely=0.243, relheight=0.556
                , relwidth=0.504)
        ...
        self.Button2.configure(font="-family {Noto Sans Display} -size 14")
        self.Button2.configure(foreground="#ffffff")
        self.Button2.configure(command=self.task2)
        self.Button2.configure(text='''Capture 5 Packets from Source''')

        self.Button3 = tk.Button(top)
        self.Button3.place(relx=0.388, rely=0.858, height=40, width=96)
        self.Button3.configure(background="#000000")
        self.Button3.configure(font=font9)
        self.Button3.configure(foreground="#f9f9f9")
