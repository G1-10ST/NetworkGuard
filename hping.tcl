...
#  Nov 18, 2019 10:01:18 AM IST  platform: Linux
set vTcl(timestamp) ""
...
proc vTclWindow.top42 {base} {
    ...
    button $top.but43 \
        ...
        -font {-family {Noto Sans Display} -size 14} -foreground #f2f2f2 \
    ...
    vTcl::widgets::ttk::scrolledlistbox::CreateCmd $top.scr44 \
        -background $vTcl(actual_gui_bg) -height 358 -highlightcolor black \
        -width 616 
    ...
    place $top.scr44 \
        -in $top -x 120 -y 100 -width 616 -relwidth 0 -height 358 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $top.but44 \
        -in $top -x 370 -y 470 -anchor nw -bordermode ignore 
